...
async def auto_rename_files(client, message):
    ...
    try:
        ...
        if media_type == "video":
            upload_args["duration"] = message.video.duration or None
            await client.send_video(file_path, **upload_args)
        elif media_type == "audio":
            await client.send_audio(file_path, **upload_args)
        else:
            await client.send_document(file_path, **upload_args)
