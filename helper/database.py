...
class Database:
    ...
    async def delete_author(self, user_id):
        await self.col.update_one({"_id": int(user_id)}, {"$unset": {"author": ""}})

    async def delete_artist(self, user_id):
        await self.col.update_one({"_id": int(user_id)}, {"$unset": {"artist": ""}})

    async def delete_audio(self, user_id):
        await self.col.update_one({"_id": int(user_id)}, {"$unset": {"audio": ""}})

    async def delete_subtitle(self, user_id):
        await self.col.update_one({"_id": int(user_id)}, {"$unset": {"subtitle": ""}})
